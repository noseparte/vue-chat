  ...
  <div class="login_box">
    ...
    <div class="login_panel">
      ...
      <div class="pass-form">
        ...
        <el-button class="send-verify-code" type="primary" :disabled="sendVerifyBtnDisabled" @click="sendVerifyCode">
          {{ sendVerifyBtnText }}
        </el-button>
      </div>
...
<script>
import {KEY_VUE_DEVICE_ID, KEY_VUE_TOKEN, KEY_VUE_USER_ID, LOGIN_API, SNED_VERIFY_CODE_API} from '../../constant'
